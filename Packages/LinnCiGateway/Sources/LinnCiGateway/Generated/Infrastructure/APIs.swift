...
internal class LinnCiGatewayAPIConfiguration: @unchecked Sendable {
    ...
    internal init(
        basePath: String = "http://www.janustechnology.co.uk/lncp",
    ...
    internal static let shared = LinnCiGatewayAPIConfiguration()
}
...
internal class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    internal let apiConfiguration: LinnCiGatewayAPIConfiguration
    ...
    required internal init(
        ...
        apiConfiguration: LinnCiGatewayAPIConfiguration = LinnCiGatewayAPIConfiguration.shared
    ) {
        self.method = method
